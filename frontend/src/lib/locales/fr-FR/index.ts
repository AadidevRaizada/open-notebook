export const frFR = {
  ...
  searchPage: {
    homeSubtitle: "Obtenez des réponses depuis votre base de connaissances",
    ...
    askModeHint: "Obtenez des réponses intelligentes",
    searchModeHint: "Trouvez des documents",
    filters: "Filtres",
