export const frFR = {
  settingsPage: {
    ...
    aiConfigDesc: "Modèles, actions sur les documents et maintenance",
    aiModelsTitle: "Modèles d'IA",
    aiModelsDesc: "Fournisseurs, clés d'API et modèles par défaut",
    documentActionsTitle: "Actions sur les documents",
    documentActionsDesc: "Comment les résumés et analyses sont générés",
    maintenanceTitle: "Maintenance",
    maintenanceDesc: "Reconstruire les index et outils avancés",
  },
  homePage: {
    securePrivate: "Vos données sont sécurisées et privées",
    greetingMorning: "Bonjour",
    greetingAfternoon: "Bon après-midi",
    greetingEvening: "Bonsoir",
    welcomeSubtitle: "Que souhaitez-vous savoir aujourd'hui ?",
    askLabel: "Interroger IRClass Navigator",
    askPlaceholder: "Posez toute question sur vos documents, réglementations ou rapports…",
    askButton: "Demander",
    example1: "Trouver des références MARPOL",
    example2: "Comparer des rapports de visite",
    example3: "Résumer les dernières circulaires",
    example4: "Lister les directives sur les eaux de ballast",
    actionUploadTitle: "Téléverser des documents",
    actionUploadDesc: "Ajoutez des fichiers, des liens ou des notes à vos connaissances",
    actionWorkspaceTitle: "Créer un espace de travail",
    actionWorkspaceDesc: "Organisez documents et notes autour d'une tâche",
    actionKnowledgeTitle: "Bibliothèque de connaissances",
    actionKnowledgeDesc: "Parcourez tout ce que votre organisation a indexé",
    actionInviteTitle: "Inviter des utilisateurs",
    actionInviteDesc: "Faites venir vos collègues sur IRClass Navigator",
    getStarted: "Commencer",
    statDocuments: "Documents indexés",
    statUsers: "Utilisateurs",
    statQueries: "Requêtes de connaissances",
    recentWorkspaces: "Espaces de travail récents",
    recentQuestions: "Questions récentes",
    recentKnowledge: "Connaissances consultées récemment",
    viewAll: "Tout afficher",
    docsCount: "{count} documents",
    noWorkspacesYet: "Aucun espace de travail pour l'instant",
    noQuestionsYet: "Vos questions apparaîtront ici",
    noKnowledgeYet: "Les documents ouverts apparaîtront ici",
    wizardTitle: "Bienvenue dans IRClass Navigator",
    wizardSubtitle: "Trois étapes jusqu'à votre première réponse",
    wizardStep1Title: "Téléversez votre premier document",
    wizardStep1Desc: "PDF, fichiers Word, liens et plus encore",
    wizardStep2Title: "Créez un espace de travail",
    wizardStep2Desc: "Un lieu pour organiser les travaux liés",
    wizardStep3Title: "Posez votre première question",
    wizardStep3Desc: "Les réponses proviennent de vos propres documents",
  },
  adminPage: {
    departmentsTab: "Départements",
    ...
    inviteSuccess: "Invitation envoyée à {email}",
    ...
    inviteModeNewOrg: "Nouvelle organisation",
    inviteModeExistingOrg: "Organisation existante",
    inviteModeNewOrgDesc: "Crée une nouvelle organisation — l'utilisateur invité en devient l'administrateur.",
    inviteModeExistingOrgDesc: "L'utilisateur invité rejoint l'organisation sélectionnée en tant que membre.",
    ...
    usageTitle: "Utilisation par utilisateur",
    usageEmpty: "Aucune activité enregistrée pour l'instant.",
    usageTotal: "Total",
    lastActive: "Dernière activité",
    recentActivity: "Activité récente",
    organizationsTitle: "Départements",
    organizationsDesc: "Rejoignez un département pour voir et gérer son contenu isolé. Changez de département actif depuis la barre supérieure.",
    ...
    actions: {
      ...
      exportReport: "Rapports",
    },
  },
  common: {
    appSubtitle: "Plateforme d'intelligence des connaissances maritimes",
    fiftyYearsAlt: "50 ans d'IRClass",
    search: "Recherche...",
    create: "Créer",
    new: "Nouveau",
    cancel: "Annuler",
    ...
    newNotebook: "Nouvel espace de travail",
    language: "Langue",
    english: "English",
    chinese: "简体中文",
    japanese: "日本語",
  ...
  navigation: {
    askNavigator: "Interroger le Navigator",
  ...
  notebooks: {
    createNewNamed: "Créer l'espace de travail \"{name}\"",
    ...
    deleteNotebook: "Supprimer l'espace de travail",
    ...
    deleteNotebookExclusiveSources: "{count} source(s) n'existent que dans cet espace de travail.",
    deleteNotebookSharedSources: "{count} source(s) sont partagées avec d'autres espaces de travail et seront dissociées.",
    deleteNotebookNoSources: "Aucune source dans cet espace de travail.",
    deleteExclusiveSourcesLabel: "Supprimer les sources exclusives",
    keepExclusiveSourcesLabel: "Délier et les conserver",
    activeNotebooks: "Espaces de travail actifs",
    archivedNotebooks: "Espaces de travail archivés",
    tileView: "Vue en mosaïque",
    listView: "Vue en liste",
    notFound: "Espace de travail introuvable",
    notFoundDesc: "L'espace de travail demandé n'existe pas.",
    updated: "Mis à jour",
    ...
    descPlaceholder: "Ajoutez plus d'informations sur cet espace de travail ici...",
    createSuccess: "Espace de travail créé avec succès",
    updateSuccess: "Espace de travail mis à jour avec succès",
    ...
    recentlyViewedNotebook: "Espace de travail",
  ...
  sources: {
    ...
    allSourcesDesc: "Tout ce que votre organisation a indexé. Ajoutez de nouveaux documents ou gérez les existants.",
    exportSummary: "Exporter le résumé Excel",
    exportSummarySuccess: "Rapport de synthèse téléchargé",
    exportSummaryError: "Échec de l'export du rapport de synthèse",
    allSources: "Connaissances",
    insights: "Aperçus",
    yes: "Oui",
    no: "Non",
    loadingMore: "Chargement...",
    noSourcesYet: "Aucune source pour le moment",
    allSourcesDescShort: "Tout ce que votre organisation a indexé.",
    ...
    id: "ID de la source",
    topics: "Sujets",
    embedded: "Prêt pour la recherche",
    ...
    previewFailed: "Impossible de charger l'aperçu du fichier.",
  ...
  chat: {
    ...
    chatWithNotebook: "Discuter avec l'espace de travail",
  ...
  searchPage: {
    ...
    conversationDisclaimer: "IRClass Navigator peut faire des erreurs. Vérifiez les informations importantes.",
    sourcesEmpty: "Les sources apparaîtront ici une fois que vous aurez posé une question",
    unifiedTitle: "Interroger IRClass Navigator",
    unifiedSubtitle: "Des réponses tirées des connaissances de votre organisation",
    unifiedPlaceholder: "Posez toute question sur vos documents, réglementations ou rapports…",
    aiNotConfigured: "Les réponses IA ne sont pas encore disponibles — un administrateur doit configurer un modèle. Les documents correspondants restent affichés ci-dessous.",
    includeNotes: "Inclure les notes",
    saveToWorkspace: "Enregistrer dans un espace de travail",
    matchingKnowledge: "Connaissances correspondantes",
    emptyKbTitle: "Votre base de connaissances est vide",
    emptyKbDesc: "Ajoutez une source pour commencer à poser des questions et rechercher dans vos documents.",
    emptyKbAction: "Ajoutez votre première source",
    tryAsking: "Essayez de demander par exemple",
    examplePrompts: {
      certRequirements: "Quelles sont les principales exigences de certification ?",
      complianceUpdates: "Résumez les dernières mises à jour de conformité",
      relatedDocuments: "Trouvez des documents liés aux audits récents",
      processExplainer: "Expliquez le processus d'enregistrement",
    },
    search: "Recherche",
  ...
  models: {
    ...
    visionModelDesc: "Utilisé pour extraire le texte des images et photos (OCR) – bascule sur le modèle de chat si non défini",
  ...
  gmail: {
    ...
    connectedServicesDesc: "Associez des comptes externes pour que Navigator puisse raisonner dessus avec vos documents. L'accès est en lecture seule.",
    connected: "Connecté",
    connect: "Connecter Gmail",
    disconnect: "Déconnecter",
    disconnected: "Gmail déconnecté",
    connectFailed: "Impossible de démarrer la connexion Gmail",
    disconnectFailed: "Impossible de déconnecter Gmail",
    notConnectedDesc: "Permettez à Navigator de chercher dans votre boîte mail en plus de vos documents. Lecture seule — rien n'est envoyé ni modifié.",
    notConfigured: "L'intégration Gmail n'est pas configurée sur ce serveur.",
    lastChecked: "Dernière vérification {{time}}",
    liveAccess: "Accès en direct activé",
    modeAuto: "Auto",
    modeAutoDesc: "Cherche dans Gmail uniquement si votre question mentionne des e-mails",
    modeDocuments: "Documents uniquement",
    modeDocumentsDesc: "Ne cherche jamais dans Gmail",
    modeDocumentsGmail: "Documents + Gmail",
    modeDocumentsGmailDesc: "Cherche toujours aussi dans Gmail",
    matchingEmails: "E-mails",
    openInGmail: "Ouvrir dans Gmail",
    connectedToast: "Gmail connecté",
    connectErrorToast: "Échec de la connexion Gmail — veuillez réessayer",
