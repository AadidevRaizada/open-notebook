export const esES = {
  settingsPage: {
    ...
    aiConfigDesc: "Modelos, acciones de documentos y mantenimiento",
    aiModelsTitle: "Modelos de IA",
    aiModelsDesc: "Proveedores, claves de API y modelos predeterminados",
    documentActionsTitle: "Acciones de documentos",
    documentActionsDesc: "Cómo se generan los resúmenes y los análisis",
    maintenanceTitle: "Mantenimiento",
    maintenanceDesc: "Reconstruir índices y herramientas avanzadas",
  },
  homePage: {
    securePrivate: "Tus datos están seguros y son privados",
    greetingMorning: "Buenos días",
    greetingAfternoon: "Buenas tardes",
    greetingEvening: "Buenas noches",
    welcomeSubtitle: "¿Qué le gustaría saber hoy?",
    askLabel: "Preguntar a IRClass Navigator",
    askPlaceholder: "Pregunte lo que quiera sobre sus documentos, normativas o informes…",
    askButton: "Preguntar",
    example1: "Buscar referencias de MARPOL",
    example2: "Comparar informes de inspección",
    example3: "Resumir las últimas circulares",
    example4: "Listar directrices sobre agua de lastre",
    actionUploadTitle: "Subir documentos",
    actionUploadDesc: "Añada archivos, enlaces o notas a su conocimiento",
    actionWorkspaceTitle: "Crear un espacio de trabajo",
    actionWorkspaceDesc: "Organice documentos y notas en torno a una tarea",
    actionKnowledgeTitle: "Biblioteca de conocimiento",
    actionKnowledgeDesc: "Explore todo lo que su organización ha indexado",
    actionInviteTitle: "Invitar usuarios",
    actionInviteDesc: "Incorpore a sus colegas a IRClass Navigator",
    getStarted: "Empezar",
    statDocuments: "Documentos indexados",
    statUsers: "Usuarios",
    statQueries: "Consultas de conocimiento",
    recentWorkspaces: "Espacios de trabajo recientes",
    recentQuestions: "Preguntas recientes",
    recentKnowledge: "Conocimiento visto recientemente",
    viewAll: "Ver todo",
    docsCount: "{count} documentos",
    noWorkspacesYet: "Aún no hay espacios de trabajo",
    noQuestionsYet: "Las preguntas que haga aparecerán aquí",
    noKnowledgeYet: "Los documentos que abra aparecerán aquí",
    wizardTitle: "Bienvenido a IRClass Navigator",
    wizardSubtitle: "Tres pasos hasta su primera respuesta",
    wizardStep1Title: "Suba su primer documento",
    wizardStep1Desc: "PDF, archivos de Word, enlaces y más",
    wizardStep2Title: "Cree un espacio de trabajo",
    wizardStep2Desc: "Un lugar para organizar el trabajo relacionado",
    wizardStep3Title: "Haga su primera pregunta",
    wizardStep3Desc: "Las respuestas provienen de sus propios documentos",
  },
  adminPage: {
    ...
    inviteModeNewOrg: "Nueva organización",
    inviteModeExistingOrg: "Organización existente",
    inviteModeNewOrgDesc: "Crea una nueva organización: el usuario invitado será su administrador.",
    inviteModeExistingOrgDesc: "El usuario invitado se une a la organización seleccionada como miembro.",
    ...
    usageTitle: "Uso por usuario",
    usageEmpty: "Aún no se ha registrado actividad.",
    usageTotal: "Total",
    lastActive: "Última actividad",
    recentActivity: "Actividad reciente",
    organizationsTitle: "Departamentos",
    organizationsDesc: "Únete a cualquier departamento para ver y gestionar su contenido aislado. Cambia el departamento activo desde la barra superior.",
    ...
    actions: {
      ...
      search: "Búsqueda",
      ask: "Preguntar",
      podcastGenerated: "Pódcasts",
      transformationRun: "Transformaciones",
      exportReport: "Informes",
    },
  },
  common: {
    appSubtitle: "Plataforma de inteligencia de conocimiento marítimo",
    fiftyYearsAlt: "50 años de IRClass",
    search: "Buscar...",
    create: "Nuevo",
    new: "Nuevo",
    cancel: "Cancelar",
    ...
    newNotebook: "Nuevo espacio de trabajo",
    language: "Idioma",
    english: "English",
    chinese: "简体中文",
    japanese: "日本語",
  ...
  navigation: {
    askNavigator: "Preguntar al Navigator",
  ...
  notebooks: {
    createNewNamed: "Crear espacio de trabajo \"{name}\"",
    ...
    deleteNotebook: "Eliminar espacio de trabajo",
    ...
    deleteNotebookExclusiveSources: "{count} fuente(s) existen solo en este espacio de trabajo.",
    deleteNotebookSharedSources: "{count} fuente(s) están compartidas con otros espacios de trabajo y se desvincularán.",
    deleteNotebookNoSources: "No hay fuentes en este espacio de trabajo.",
    deleteExclusiveSourcesLabel: "Eliminar fuentes exclusivas",
    keepExclusiveSourcesLabel: "Desvincular y conservarlas",
    activeNotebooks: "Espacios de trabajo activos",
    archivedNotebooks: "Espacios de trabajo archivados",
    tileView: "Vista de mosaico",
    listView: "Vista de lista",
    notFound: "Espacio de trabajo no encontrado",
    notFoundDesc: "El espacio de trabajo solicitado no existe.",
    updated: "Actualizado",
    ...
    descPlaceholder: "Añade más información sobre este espacio de trabajo aquí...",
    createSuccess: "Espacio de trabajo creado correctamente",
    updateSuccess: "Espacio de trabajo actualizado correctamente",
    deleteSuccess: "Espacio de trabajo eliminado correctamente",
    recentlyViewed: "Vistos recientemente",
    toggleRecentlyViewed: "Alternar vistos recientemente",
    recentlyViewedNotebook: "Espacio de trabajo",
  ...
  sources: {
    ...
    allSourcesDesc: "Todo lo que tu organización ha indexado. Añade nuevos documentos o gestiona los existentes.",
    exportSummary: "Exportar resumen a Excel",
    exportSummarySuccess: "Informe de resumen descargado",
    exportSummaryError: "Error al exportar el informe de resumen",
    allSources: "Conocimiento",
    insights: "Análisis",
    yes: "Sí",
    no: "No",
    loadingMore: "Cargando más...",
    noSourcesYet: "Aún no hay fuentes",
    allSourcesDescShort: "Todo lo que tu organización ha indexado.",
    ...
    previewFailed: "No se pudo cargar la vista previa del archivo.",
  ...
  chat: {
    ...
    chatWithNotebook: "Chat con el espacio de trabajo",
  ...
  searchPage: {
    ...
    conversationDisclaimer: "IRClass Navigator puede cometer errores. Verifica la información importante.",
    sourcesEmpty: "Las fuentes aparecerán aquí cuando hagas una pregunta",
    unifiedTitle: "Preguntar a IRClass Navigator",
    unifiedSubtitle: "Respuestas extraídas del conocimiento de su organización",
    unifiedPlaceholder: "Pregunte lo que quiera sobre sus documentos, normativas o informes…",
    aiNotConfigured: "Las respuestas de IA aún no están disponibles: un administrador debe configurar un modelo. Los documentos coincidentes se muestran abajo.",
    includeNotes: "Incluir notas",
    saveToWorkspace: "Guardar en espacio de trabajo",
    matchingKnowledge: "Conocimiento coincidente",
    emptyKbTitle: "Tu base de conocimiento está vacía",
    emptyKbDesc: "Añade una fuente para empezar a hacer preguntas y buscar en tus documentos.",
    emptyKbAction: "Añade tu primera fuente",
    tryAsking: "Prueba a preguntar algo como",
    examplePrompts: {
      certRequirements: "¿Cuáles son los requisitos clave de certificación?",
      complianceUpdates: "Resume las últimas actualizaciones de cumplimiento",
      relatedDocuments: "Encuentra documentos relacionados con auditorías recientes",
      processExplainer: "Explica el proceso de registro",
    },
    search: "Buscar",
  ...
  models: {
    ...
    visionModelDesc: "Se usa para extraer texto de imágenes y fotos (OCR); si no está definido, se usa el modelo de chat",
  ...
  gmail: {
    ...
    connectedServicesDesc: "Vincula cuentas externas para que Navigator pueda razonar sobre ellas junto con tus documentos. El acceso es de solo lectura.",
    connected: "Conectado",
    connect: "Conectar Gmail",
    disconnect: "Desconectar",
    disconnected: "Gmail desconectado",
    connectFailed: "No se pudo iniciar la conexión con Gmail",
    disconnectFailed: "No se pudo desconectar Gmail",
    notConnectedDesc: "Permite que Navigator busque en tu buzón junto con tus documentos. Solo lectura: no se envía ni se modifica nada.",
    notConfigured: "La integración con Gmail no está configurada en este servidor.",
    lastChecked: "Última comprobación {{time}}",
    liveAccess: "Acceso en vivo activado",
    modeAuto: "Auto",
    modeAutoDesc: "Busca en Gmail solo cuando tu pregunta menciona correos",
    modeDocuments: "Solo documentos",
    modeDocumentsDesc: "Nunca busca en Gmail",
    modeDocumentsGmail: "Documentos + Gmail",
    modeDocumentsGmailDesc: "Siempre busca también en Gmail",
    matchingEmails: "Correos",
    openInGmail: "Abrir en Gmail",
    connectedToast: "Gmail conectado",
    connectErrorToast: "Error al conectar Gmail: inténtalo de nuevo",
