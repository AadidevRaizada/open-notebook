export const zhTW = {
  settingsPage: {
    aiConfigTitle: "AI 設定",
    aiConfigDesc: "模型、文件動作和維護",
    aiModelsTitle: "AI 模型",
    aiModelsDesc: "供應商、API 金鑰和預設模型",
    documentActionsTitle: "文件動作",
    documentActionsDesc: "摘要和洞察的產生方式",
    maintenanceTitle: "維護",
    maintenanceDesc: "重建索引和進階工具",
  },
  homePage: {
    securePrivate: "您的資料安全且私密",
    greetingMorning: "早安",
    greetingAfternoon: "午安",
    greetingEvening: "晚安",
    welcomeSubtitle: "今天您想了解什麼?",
    askLabel: "向 IRClass Navigator 提問",
    askPlaceholder: "詢問有關您的文件、法規或報告的任何問題…",
    askButton: "提問",
    example1: "查找 MARPOL 相關條款",
    example2: "比較檢驗報告",
    example3: "總結最新通函",
    example4: "列出壓載水指南",
    actionUploadTitle: "上傳文件",
    actionUploadDesc: "將檔案、連結或筆記加入您的知識庫",
    actionWorkspaceTitle: "建立工作區",
    actionWorkspaceDesc: "圍繞任務整理文件和筆記",
    actionKnowledgeTitle: "知識庫",
    actionKnowledgeDesc: "瀏覽您的組織已索引的所有內容",
    actionInviteTitle: "邀請使用者",
    actionInviteDesc: "邀請同事加入 IRClass Navigator",
    getStarted: "開始使用",
    statDocuments: "已索引文件",
    statUsers: "使用者",
    statQueries: "知識查詢",
    ...
    recentKnowledge: "最近檢視的知識",
    viewAll: "檢視全部",
    docsCount: "{count} 個文件",
    noWorkspacesYet: "還沒有工作區",
    noQuestionsYet: "您提出的問題將顯示在這裡",
    noKnowledgeYet: "您開啟的文件將顯示在這裡",
    wizardTitle: "歡迎使用 IRClass Navigator",
    wizardSubtitle: "三步驟獲得第一個答案",
    wizardStep1Title: "上傳您的第一個文件",
    wizardStep1Desc: "PDF、Word 檔案、連結等",
    wizardStep2Title: "建立工作區",
    wizardStep2Desc: "整理相關工作的空間",
    wizardStep3Title: "提出您的第一個問題",
    wizardStep3Desc: "答案來自您自己的文件",
  },
  adminPage: {
    departmentsTab: "部門",
    title: "管理",
    ...
    inviteButton: "傳送邀請",
    inviteModeNewOrg: "新增組織",
    inviteModeExistingOrg: "現有組織",
    inviteModeNewOrgDesc: "建立一個新組織——受邀使用者將成為該組織的管理員。",
    inviteModeExistingOrgDesc: "受邀使用者將以成員身分加入所選組織。",
    ...
    usageTitle: "依使用者統計的使用情況",
    usageEmpty: "尚未記錄任何活動。",
    usageTotal: "總計",
    lastActive: "最後活躍",
    recentActivity: "最近活動",
    organizationsTitle: "部門",
    organizationsDesc: "加入任一部門即可檢視和管理其獨立內容。可在頂部列切換目前部門。",
    ...
    actions: {
      ...
      transformationRun: "轉換",
      exportReport: "報告",
    },
  },
  common: {
    appSubtitle: "海事知識智慧平台",
    fiftyYearsAlt: "IRClass 50 週年",
    search: "搜尋...",
    create: "新增",
    new: "新建",
    cancel: "取消",
  ...
  notebooks: {
    ...
    deleteNotebookExclusiveSources: "{count} 個來源僅存在於此工作區。",
    deleteNotebookSharedSources: "{count} 個來源與其他工作區共用，將被解除連結。",
    deleteNotebookNoSources: "此工作區中沒有來源。",
    deleteExclusiveSourcesLabel: "刪除專屬來源",
    keepExclusiveSourcesLabel: "取消關聯並保留",
    activeNotebooks: "使用中的工作區",
    archivedNotebooks: "已封存的工作區",
    tileView: "並排檢視",
    listView: "清單檢視",
    notFound: "找不到工作區",
    notFoundDesc: "請求的工作區不存在。",
    updated: "已更新",
    ...
    descPlaceholder: "在此新增有關此工作區的更多資訊...",
    createSuccess: "工作區建立成功",
    updateSuccess: "工作區更新成功",
    deleteSuccess: "工作區刪除成功",
    recentlyViewed: "最近檢視",
    toggleRecentlyViewed: "切換最近檢視",
    recentlyViewedNotebook: "工作區",
  ...
  sources: {
    ...
    failedToLoad: "載入來源失敗",
    allSourcesDesc: "組織已索引的全部內容。新增文件或管理現有文件。",
    exportSummary: "匯出 Excel 摘要",
    exportSummarySuccess: "摘要報告已下載",
    exportSummaryError: "匯出摘要報告失敗",
    allSources: "知識",
    insights: "見解",
    yes: "是",
    no: "否",
    loadingMore: "正在載入更多...",
    noSourcesYet: "暫無來源",
    allSourcesDescShort: "組織已索引的全部內容。",
  ...
  searchPage: {
    sources: "來源",
    regenerate: "重新產生",
    conversationDisclaimer: "IRClass Navigator 可能會出錯，請核實重要資訊。",
    sourcesEmpty: "提問後來源將顯示在此處",
    unifiedTitle: "向 IRClass Navigator 提問",
    unifiedSubtitle: "答案來自您組織的知識",
    unifiedPlaceholder: "詢問有關您的文件、法規或報告的任何問題…",
    aiNotConfigured: "AI 回答尚不可用——需要管理員設定模型。相符的文件仍顯示在下方。",
    includeNotes: "包含筆記",
    saveToWorkspace: "儲存到工作區",
    matchingKnowledge: "相符的知識",
    emptyKbTitle: "您的知識庫是空的",
    emptyKbDesc: "新增來源即可開始提問和搜尋您的文件。",
    emptyKbAction: "新增您的第一個來源",
    tryAsking: "試著問問",
    examplePrompts: {
      certRequirements: "關鍵認證要求有哪些？",
      complianceUpdates: "總結最新的合規更新",
      relatedDocuments: "尋找與近期稽核相關的文件",
      processExplainer: "解釋註冊流程",
    },
    search: "搜尋",
  ...
  models: {
    ...
    visionModelDesc: "用於從圖像和照片中擷取文字（OCR）- 未設定時回退到聊天模型",
    embedding: "嵌入模型",
    tts: "文字轉語音",
    stt: "語音轉文字",
    apiKey: "API 密鑰",
  ...
  gmail: {
    connectedServices: "已連接服務",
    connectedServicesDesc: "連結外部帳戶，讓 Navigator 可以將其與您的文件一起分析。存取權限為唯讀。",
    connected: "已連接",
    connect: "連接 Gmail",
    disconnect: "中斷連接",
    disconnected: "Gmail 已中斷連接",
    connectFailed: "無法啟動 Gmail 連接",
    disconnectFailed: "無法中斷 Gmail 連接",
    notConnectedDesc: "允許 Navigator 在搜尋文件的同時搜尋您的信箱。唯讀權限——不會傳送或變更任何內容。",
    notConfigured: "此伺服器未設定 Gmail 整合。",
    lastChecked: "上次檢查 {{time}}",
    liveAccess: "即時存取已啟用",
    modeAuto: "自動",
    modeAutoDesc: "僅當問題涉及郵件時才搜尋 Gmail",
    modeDocuments: "僅文件",
    modeDocumentsDesc: "從不搜尋 Gmail",
    modeDocumentsGmail: "文件 + Gmail",
    modeDocumentsGmailDesc: "始終同時搜尋 Gmail",
    matchingEmails: "郵件",
    openInGmail: "在 Gmail 中開啟",
    connectedToast: "Gmail 已連接",
    connectErrorToast: "Gmail 連接失敗，請重試",
