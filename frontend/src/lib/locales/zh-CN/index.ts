export const zhCN = {
  settingsPage: {
    aiConfigTitle: "AI 配置",
    aiConfigDesc: "模型、文档操作和维护",
    aiModelsTitle: "AI 模型",
    aiModelsDesc: "提供商、API 密钥和默认模型",
    documentActionsTitle: "文档操作",
    documentActionsDesc: "摘要和洞察的生成方式",
    maintenanceTitle: "维护",
    maintenanceDesc: "重建索引和高级工具",
  },
  homePage: {
    securePrivate: "您的数据安全且私密",
    greetingMorning: "早上好",
    greetingAfternoon: "下午好",
    greetingEvening: "晚上好",
    welcomeSubtitle: "今天您想了解什么?",
    askLabel: "向 IRClass Navigator 提问",
    askPlaceholder: "询问有关您的文档、法规或报告的任何问题…",
    askButton: "提问",
    example1: "查找 MARPOL 相关条款",
    example2: "比较检验报告",
    example3: "总结最新通函",
    example4: "列出压载水指南",
    actionUploadTitle: "上传文档",
    actionUploadDesc: "将文件、链接或笔记添加到您的知识库",
    actionWorkspaceTitle: "创建工作区",
    actionWorkspaceDesc: "围绕任务组织文档和笔记",
    actionKnowledgeTitle: "知识库",
    actionKnowledgeDesc: "浏览您的组织已索引的所有内容",
    actionInviteTitle: "邀请用户",
    actionInviteDesc: "邀请同事加入 IRClass Navigator",
    getStarted: "开始使用",
    statDocuments: "已索引文档",
    statUsers: "用户",
    statQueries: "知识查询",
    ...
    recentKnowledge: "最近查看的知识",
    viewAll: "查看全部",
    docsCount: "{count} 个文档",
    noWorkspacesYet: "还没有工作区",
    noQuestionsYet: "您提出的问题将显示在这里",
    noKnowledgeYet: "您打开的文档将显示在这里",
    wizardTitle: "欢迎使用 IRClass Navigator",
    wizardSubtitle: "三步获得第一个答案",
    wizardStep1Title: "上传您的第一个文档",
    wizardStep1Desc: "PDF、Word 文件、链接等",
    wizardStep2Title: "创建工作区",
    wizardStep2Desc: "组织相关工作的空间",
    wizardStep3Title: "提出您的第一个问题",
    wizardStep3Desc: "答案来自您自己的文档",
  },
  adminPage: {
    departmentsTab: "部门",
    title: "管理",
    ...
    inviteButton: "发送邀请",
    inviteModeNewOrg: "新建组织",
    inviteModeExistingOrg: "现有组织",
    inviteModeNewOrgDesc: "创建一个新组织——受邀用户将成为该组织的管理员。",
    inviteModeExistingOrgDesc: "受邀用户将以成员身份加入所选组织。",
    ...
    usageTitle: "按用户统计的使用情况",
    usageEmpty: "尚未记录任何活动。",
    usageTotal: "总计",
    lastActive: "最后活跃",
    recentActivity: "最近活动",
    organizationsTitle: "部门",
    organizationsDesc: "加入任意部门即可查看和管理其独立内容。可在顶部栏切换当前部门。",
    ...
    actions: {
      ...
      ask: "提问",
      podcastGenerated: "播客",
      transformationRun: "转换",
      exportReport: "报告",
    },
  },
  common: {
    appSubtitle: "海事知识智能平台",
  ...
  notebooks: {
    ...
    deleteNotebookExclusiveSources: "{count} 个来源仅存在于此工作区。",
    deleteNotebookSharedSources: "{count} 个来源与其他工作区共享，将被解除关联。",
    deleteNotebookNoSources: "此工作区中没有来源。",
    deleteExclusiveSourcesLabel: "删除专属来源",
    keepExclusiveSourcesLabel: "取消关联并保留",
    activeNotebooks: "活跃工作区",
    archivedNotebooks: "已归档工作区",
    tileView: "平铺视图",
    listView: "列表视图",
    notFound: "未找到工作区",
    notFoundDesc: "请求的工作区不存在。",
    updated: "已更新",
  ...
  sources: {
    ...
    failedToLoad: "加载来源失败",
    allSourcesDesc: "组织已索引的全部内容。添加新文档或管理现有文档。",
    exportSummary: "导出 Excel 摘要",
    exportSummarySuccess: "摘要报告已下载",
    exportSummaryError: "导出摘要报告失败",
    allSources: "知识",
    insights: "见解",
    yes: "是",
    no: "否",
    loadingMore: "正在加载更多...",
    noSourcesYet: "暂无来源",
    allSourcesDescShort: "组织已索引的全部内容。",
  ...
  searchPage: {
    sources: "来源",
    regenerate: "重新生成",
    conversationDisclaimer: "IRClass Navigator 可能会出错，请核实重要信息。",
    sourcesEmpty: "提问后来源将显示在此处",
    unifiedTitle: "向 IRClass Navigator 提问",
    unifiedSubtitle: "答案来自您组织的知识",
    unifiedPlaceholder: "询问有关您的文档、法规或报告的任何问题…",
    aiNotConfigured: "AI 回答尚不可用——需要管理员配置模型。匹配的文档仍显示在下方。",
    includeNotes: "包含笔记",
    saveToWorkspace: "保存到工作区",
    matchingKnowledge: "匹配的知识",
    emptyKbTitle: "您的知识库是空的",
    emptyKbDesc: "添加来源即可开始提问和搜索您的文档。",
    emptyKbAction: "添加您的第一个来源",
    tryAsking: "试着问问",
    examplePrompts: {
      certRequirements: "关键认证要求有哪些？",
      complianceUpdates: "总结最新的合规更新",
      relatedDocuments: "查找与近期审计相关的文档",
      processExplainer: "解释注册流程",
    },
    search: "搜索",
  ...
  models: {
    ...
    visionModelDesc: "用于从图像和照片中提取文本（OCR）- 未设置时回退到聊天模型",
    embedding: "嵌入模型",
    tts: "文字转语音",
    stt: "语音转文字",
    apiKey: "API 密钥",
  ...
  gmail: {
    ...
    connectedServicesDesc: "关联外部账户，让 Navigator 可以将其与您的文档一起分析。访问权限为只读。",
    connected: "已连接",
    connect: "连接 Gmail",
    disconnect: "断开连接",
    disconnected: "Gmail 已断开连接",
    connectFailed: "无法启动 Gmail 连接",
    disconnectFailed: "无法断开 Gmail 连接",
    notConnectedDesc: "允许 Navigator 在搜索文档的同时搜索您的邮箱。只读权限——不会发送或更改任何内容。",
    notConfigured: "此服务器未配置 Gmail 集成。",
    lastChecked: "上次检查 {{time}}",
    liveAccess: "实时访问已启用",
    modeAuto: "自动",
    modeAutoDesc: "仅当问题涉及邮件时才搜索 Gmail",
    modeDocuments: "仅文档",
    modeDocumentsDesc: "从不搜索 Gmail",
    modeDocumentsGmail: "文档 + Gmail",
    modeDocumentsGmailDesc: "始终同时搜索 Gmail",
    matchingEmails: "邮件",
    openInGmail: "在 Gmail 中打开",
    connectedToast: "Gmail 已连接",
    connectErrorToast: "Gmail 连接失败，请重试",
