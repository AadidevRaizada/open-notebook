export const itIT = {
  settingsPage: {
    aiConfigTitle: "Configurazione IA",
    aiConfigDesc: "Modelli, azioni sui documenti e manutenzione",
    aiModelsTitle: "Modelli IA",
    aiModelsDesc: "Provider, chiavi API e modelli predefiniti",
    documentActionsTitle: "Azioni sui documenti",
    documentActionsDesc: "Come vengono generati riassunti e approfondimenti",
    maintenanceTitle: "Manutenzione",
    maintenanceDesc: "Ricostruzione degli indici e strumenti avanzati",
  },
  homePage: {
    securePrivate: "I tuoi dati sono sicuri e privati",
    greetingMorning: "Buongiorno",
    greetingAfternoon: "Buon pomeriggio",
    greetingEvening: "Buonasera",
    welcomeSubtitle: "Cosa vorresti sapere oggi?",
    askLabel: "Chiedi a IRClass Navigator",
    askPlaceholder: "Chiedi qualsiasi cosa sui tuoi documenti, normative o rapporti…",
    askButton: "Chiedi",
    example1: "Trova riferimenti MARPOL",
    example2: "Confronta i rapporti di ispezione",
    example3: "Riassumi le ultime circolari",
    example4: "Elenca le linee guida sulle acque di zavorra",
    actionUploadTitle: "Carica documenti",
    actionUploadDesc: "Aggiungi file, link o note alla tua conoscenza",
    actionWorkspaceTitle: "Crea uno spazio di lavoro",
    actionWorkspaceDesc: "Organizza documenti e note attorno a un'attività",
    actionKnowledgeTitle: "Biblioteca della conoscenza",
    actionKnowledgeDesc: "Sfoglia tutto ciò che la tua organizzazione ha indicizzato",
    actionInviteTitle: "Invita utenti",
    actionInviteDesc: "Porta i colleghi su IRClass Navigator",
    getStarted: "Inizia",
    statDocuments: "Documenti indicizzati",
    statUsers: "Utenti",
    statQueries: "Interrogazioni della conoscenza",
    recentWorkspaces: "Spazi di lavoro recenti",
    recentQuestions: "Domande recenti",
    recentKnowledge: "Conoscenza consultata di recente",
    viewAll: "Vedi tutto",
    docsCount: "{count} documenti",
    noWorkspacesYet: "Ancora nessuno spazio di lavoro",
    noQuestionsYet: "Le domande che farai appariranno qui",
    noKnowledgeYet: "I documenti che apri appariranno qui",
    wizardTitle: "Benvenuto in IRClass Navigator",
    wizardSubtitle: "Tre passaggi fino alla tua prima risposta",
    wizardStep1Title: "Carica il tuo primo documento",
    wizardStep1Desc: "PDF, file Word, link e altro",
    wizardStep2Title: "Crea uno spazio di lavoro",
    wizardStep2Desc: "Un luogo per organizzare il lavoro correlato",
    wizardStep3Title: "Fai la tua prima domanda",
    wizardStep3Desc: "Le risposte provengono dai tuoi documenti",
  },
  adminPage: {
    departmentsTab: "Dipartimenti",
    ...
    inviteError: "Invio dell'invito non riuscito",
    actionSuccess: "Fatto",
    actionError: "Azione non riuscita",
    inviteTitle: "Invita un utente",
    invitePlaceholder: "email@example.com",
    inviteButton: "Invia invito",
    inviteModeNewOrg: "Nuova organizzazione",
    inviteModeExistingOrg: "Organizzazione esistente",
    inviteModeNewOrgDesc: "Crea una nuova organizzazione: l'utente invitato ne diventa l'amministratore.",
    inviteModeExistingOrgDesc: "L'utente invitato entra nell'organizzazione selezionata come membro.",
    orgNamePlaceholder: "Nome dell'organizzazione",
    ...
    usageTitle: "Utilizzo per utente",
    usageEmpty: "Nessuna attività registrata finora.",
    usageTotal: "Totale",
    lastActive: "Ultima attività",
    recentActivity: "Attività recente",
    organizationsTitle: "Dipartimenti",
    organizationsDesc: "Unisciti a un dipartimento per visualizzare e gestire i suoi contenuti isolati. Cambia il dipartimento attivo dalla barra superiore.",
    ...
    actions: {
      ...
      transformationRun: "Trasformazioni",
      exportReport: "Report",
    },
  },
  common: {
    appSubtitle: "Piattaforma di intelligenza della conoscenza marittima",
    fiftyYearsAlt: "50 anni di IRClass",
    search: "Cerca...",
    create: "Nuovo",
    new: "Nuovo",
    cancel: "Annulla",
    ...
    system: "Sistema",
    loading: "Caricamento...",
    adminOnly: "È richiesto l'accesso amministratore",
    note: "Nota",
    insight: "Approfondimento",
    newSource: "Nuova fonte",
    newNotebook: "Nuovo spazio di lavoro",
    language: "Lingua",
    english: "English",
    chinese: "简体中文",
    japanese: "日本語",
  ...
  navigation: {
    askNavigator: "Chiedi al Navigator",
    knowledge: "Conoscenza",
    workspaces: "Spazi di lavoro",
    usersAccess: "Utenti e accessi",
  ...
  notebooks: {
    createNewNamed: "Crea spazio di lavoro \"{name}\"",
    ...
    deleteNotebook: "Elimina spazio di lavoro",
    ...
    deleteNotebookExclusiveSources: "{count} fonte/i esistono solo in questo spazio di lavoro.",
    deleteNotebookSharedSources: "{count} fonte/i sono condivise con altri spazi di lavoro e verranno scollegate.",
    deleteNotebookNoSources: "Nessuna fonte in questo spazio di lavoro.",
    deleteExclusiveSourcesLabel: "Elimina fonti esclusive",
    keepExclusiveSourcesLabel: "Scollega e mantieni",
    activeNotebooks: "Spazi di lavoro attivi",
    archivedNotebooks: "Spazi di lavoro archiviati",
    tileView: "Vista a riquadri",
    listView: "Vista a elenco",
    notFound: "Spazio di lavoro non trovato",
    notFoundDesc: "Lo spazio di lavoro richiesto non esiste.",
    updated: "Aggiornato",
    ...
    createNew: "Crea nuovo spazio di lavoro",
    createNewDesc: "Inserisci un nome e una descrizione opzionale per iniziare.",
    descPlaceholder: "Aggiungi qui altre informazioni su questo spazio di lavoro...",
    createSuccess: "Spazio di lavoro creato con successo",
    updateSuccess: "Spazio di lavoro aggiornato con successo",
    deleteSuccess: "Spazio di lavoro eliminato con successo",
    recentlyViewed: "Visti di recente",
    toggleRecentlyViewed: "Mostra/nascondi visti di recente",
    recentlyViewedNotebook: "Spazio di lavoro",
  ...
  sources: {
    ...
    allSourcesDesc: "Tutto ciò che la tua organizzazione ha indicizzato. Aggiungi nuovi documenti o gestisci quelli esistenti.",
    exportSummary: "Esporta riepilogo Excel",
    exportSummarySuccess: "Report di riepilogo scaricato",
    exportSummaryError: "Esportazione del report di riepilogo non riuscita",
    allSources: "Conoscenza",
    insights: "Approfondimenti",
    yes: "Sì",
    no: "No",
    loadingMore: "Caricamento...",
    noSourcesYet: "Ancora nessuna fonte",
    allSourcesDescShort: "Tutto ciò che la tua organizzazione ha indicizzato.",
    ...
    id: "ID Fonte",
    topics: "Argomenti",
    embedded: "Pronto per la ricerca",
    ...
    previewFailed: "Impossibile caricare l'anteprima del file.",
  ...
  chat: {
    ...
    chatWithNotebook: "Chat con lo spazio di lavoro",
  ...
  searchPage: {
    sources: "Fonti",
    regenerate: "Rigenera",
    conversationDisclaimer: "IRClass Navigator può commettere errori. Verifica le informazioni importanti.",
    sourcesEmpty: "Le fonti appariranno qui dopo aver posto una domanda",
    unifiedTitle: "Chiedi a IRClass Navigator",
    unifiedSubtitle: "Risposte tratte dalla conoscenza della tua organizzazione",
    unifiedPlaceholder: "Chiedi qualsiasi cosa sui tuoi documenti, normative o rapporti…",
    aiNotConfigured: "Le risposte IA non sono ancora disponibili: un amministratore deve configurare un modello. I documenti corrispondenti sono comunque mostrati sotto.",
    includeNotes: "Includi le note",
    saveToWorkspace: "Salva nello spazio di lavoro",
    matchingKnowledge: "Conoscenza corrispondente",
    emptyKbTitle: "La tua base di conoscenza è vuota",
    emptyKbDesc: "Aggiungi una fonte per iniziare a fare domande e cercare nei tuoi documenti.",
    emptyKbAction: "Aggiungi la tua prima fonte",
    tryAsking: "Prova a chiedere qualcosa come",
    examplePrompts: {
      certRequirements: "Quali sono i requisiti chiave di certificazione?",
      complianceUpdates: "Riassumi gli ultimi aggiornamenti sulla conformità",
      relatedDocuments: "Trova documenti relativi agli audit recenti",
      processExplainer: "Spiega il processo di registrazione",
    },
    search: "Cerca",
  ...
  models: {
    ...
    visionModelDesc: "Usato per estrarre testo da immagini e foto (OCR); se non impostato, si usa il modello di chat",
  ...
  gmail: {
    ...
    connectedServicesDesc: "Collega account esterni così Navigator può ragionare su di essi insieme ai tuoi documenti. L'accesso è di sola lettura.",
    connected: "Collegato",
    connect: "Collega Gmail",
    disconnect: "Scollega",
    disconnected: "Gmail scollegato",
    connectFailed: "Impossibile avviare la connessione a Gmail",
    disconnectFailed: "Impossibile scollegare Gmail",
    notConnectedDesc: "Consenti a Navigator di cercare nella tua casella insieme ai tuoi documenti. Sola lettura: nulla viene inviato o modificato.",
    notConfigured: "L'integrazione Gmail non è configurata su questo server.",
    lastChecked: "Ultimo controllo {{time}}",
    liveAccess: "Accesso live attivo",
    modeAuto: "Auto",
    modeAutoDesc: "Cerca in Gmail solo quando la domanda menziona le email",
    modeDocuments: "Solo documenti",
    modeDocumentsDesc: "Non cerca mai in Gmail",
    modeDocumentsGmail: "Documenti + Gmail",
    modeDocumentsGmailDesc: "Cerca sempre anche in Gmail",
    matchingEmails: "Email",
    openInGmail: "Apri in Gmail",
    connectedToast: "Gmail collegato",
    connectErrorToast: "Connessione a Gmail non riuscita: riprova",
