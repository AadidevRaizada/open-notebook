export const bnIN = {
  settingsPage: {
    aiConfigTitle: "AI কনফিগারেশন",
    aiConfigDesc: "মডেল, নথির কার্যক্রম এবং রক্ষণাবেক্ষণ",
    aiModelsTitle: "AI মডেল",
    aiModelsDesc: "প্রোভাইডার, API কী এবং ডিফল্ট মডেল",
    documentActionsTitle: "নথির কার্যক্রম",
    documentActionsDesc: "সারসংক্ষেপ ও অন্তর্দৃষ্টি কীভাবে তৈরি হয়",
    maintenanceTitle: "রক্ষণাবেক্ষণ",
    maintenanceDesc: "সূচি পুনর্নির্মাণ এবং উন্নত সরঞ্জাম",
  },
  homePage: {
    securePrivate: "আপনার ডেটা সুরক্ষিত এবং ব্যক্তিগত",
    greetingMorning: "সুপ্রভাত",
    greetingAfternoon: "শুভ অপরাহ্ন",
    greetingEvening: "শুভ সন্ধ্যা",
    welcomeSubtitle: "আজ আপনি কী জানতে চান?",
    askLabel: "IRClass Navigator-কে জিজ্ঞাসা করুন",
    askPlaceholder: "আপনার নথি, বিধি বা প্রতিবেদন সম্পর্কে যেকোনো কিছু জিজ্ঞাসা করুন…",
    askButton: "জিজ্ঞাসা করুন",
    example1: "MARPOL রেফারেন্স খুঁজুন",
    example2: "সার্ভে রিপোর্ট তুলনা করুন",
    example3: "সর্বশেষ সার্কুলারগুলির সারসংক্ষেপ করুন",
    example4: "ব্যালাস্ট ওয়াটার নির্দেশিকা তালিকাভুক্ত করুন",
    actionUploadTitle: "নথি আপলোড করুন",
    actionUploadDesc: "আপনার জ্ঞানভান্ডারে ফাইল, লিঙ্ক বা নোট যোগ করুন",
    actionWorkspaceTitle: "ওয়ার্কস্পেস তৈরি করুন",
    actionWorkspaceDesc: "একটি কাজ ঘিরে নথি ও নোট সংগঠিত করুন",
    actionKnowledgeTitle: "জ্ঞান লাইব্রেরি",
    actionKnowledgeDesc: "আপনার সংস্থা যা কিছু সূচিবদ্ধ করেছে তা ব্রাউজ করুন",
    actionInviteTitle: "ব্যবহারকারীদের আমন্ত্রণ জানান",
    actionInviteDesc: "সহকর্মীদের IRClass Navigator-এ আনুন",
    getStarted: "শুরু করুন",
    statDocuments: "সূচিবদ্ধ নথি",
    statUsers: "ব্যবহারকারী",
    statQueries: "জ্ঞান অনুসন্ধান",
    recentWorkspaces: "সাম্প্রতিক ওয়ার্কস্পেস",
    recentQuestions: "সাম্প্রতিক প্রশ্ন",
    recentKnowledge: "সম্প্রতি দেখা জ্ঞান",
    viewAll: "সব দেখুন",
    docsCount: "{count}টি নথি",
    noWorkspacesYet: "এখনও কোনো ওয়ার্কস্পেস নেই",
    noQuestionsYet: "আপনার জিজ্ঞাসা করা প্রশ্ন এখানে দেখা যাবে",
    noKnowledgeYet: "আপনি যে নথি খুলবেন তা এখানে দেখা যাবে",
    wizardTitle: "IRClass Navigator-এ স্বাগতম",
    wizardSubtitle: "প্রথম উত্তরের জন্য তিনটি ধাপ",
    wizardStep1Title: "আপনার প্রথম নথি আপলোড করুন",
    wizardStep1Desc: "PDF, Word ফাইল, লিঙ্ক এবং আরও অনেক কিছু",
    wizardStep2Title: "একটি ওয়ার্কস্পেস তৈরি করুন",
    wizardStep2Desc: "সম্পর্কিত কাজ সংগঠিত করার জায়গা",
    wizardStep3Title: "আপনার প্রথম প্রশ্ন জিজ্ঞাসা করুন",
    wizardStep3Desc: "উত্তর আসে আপনার নিজের নথি থেকে",
  },
  adminPage: {
    departmentsTab: "বিভাগ",
    title: "অ্যাডমিন",
    ...
    inviteSuccess: "{email}-এ আমন্ত্রণ পাঠানো হয়েছে",
    inviteError: "আমন্ত্রণ পাঠাতে ব্যর্থ হয়েছে",
    actionSuccess: "সম্পন্ন হয়েছে",
    actionError: "কাজটি ব্যর্থ হয়েছে",
    inviteTitle: "একজন ব্যবহারকারীকে আমন্ত্রণ জানান",
    invitePlaceholder: "email@example.com",
    inviteButton: "আমন্ত্রণ পাঠান",
    inviteModeNewOrg: "নতুন প্রতিষ্ঠান",
    inviteModeExistingOrg: "বিদ্যমান প্রতিষ্ঠান",
    inviteModeNewOrgDesc: "একটি নতুন প্রতিষ্ঠান তৈরি করে — আমন্ত্রিত ব্যবহারকারী এর অ্যাডমিন হবেন।",
    inviteModeExistingOrgDesc: "আমন্ত্রিত ব্যবহারকারী নির্বাচিত প্রতিষ্ঠানে সদস্য হিসেবে যুক্ত হবেন।",
    orgNamePlaceholder: "প্রতিষ্ঠানের নাম",
    selectOrganization: "একটি প্রতিষ্ঠান নির্বাচন করুন",
    pendingInvitations: "মুলতুবি আমন্ত্রণ",
    ...
    unbanUser: "নিষেধাজ্ঞা তুলে নিন",
    banUser: "ব্যবহারকারীকে নিষিদ্ধ করুন",
    deleteUser: "ব্যবহারকারী মুছুন",
    deleteConfirmTitle: "ব্যবহারকারী মুছবেন?",
    ...
    usageTitle: "ব্যবহারকারী অনুযায়ী ব্যবহার",
    usageEmpty: "এখনও কোনো কার্যকলাপ রেকর্ড করা হয়নি।",
    usageTotal: "মোট",
    lastActive: "সর্বশেষ সক্রিয়",
    recentActivity: "সাম্প্রতিক কার্যকলাপ",
    organizationsTitle: "বিভাগ",
    organizationsDesc: "যেকোনো বিভাগে যোগ দিয়ে তার আলাদা কন্টেন্ট দেখুন ও পরিচালনা করুন। উপরের বার থেকে সক্রিয় বিভাগ পরিবর্তন করুন।",
    ...
    actions: {
      ...
      search: "অনুসন্ধান",
      ask: "জিজ্ঞাসা",
      podcastGenerated: "পডকাস্ট",
      transformationRun: "রূপান্তর",
      exportReport: "রিপোর্ট",
    },
  },
  common: {
    appSubtitle: "সামুদ্রিক জ্ঞান বুদ্ধিমত্তা প্ল্যাটফর্ম",
    fiftyYearsAlt: "IRClass-এর ৫০ বছর",
    search: "অনুসন্ধান...",
    create: "নতুন",
    new: "নতুন",
    cancel: "বাতিল",
    ...
    system: "সিস্টেম",
    loading: "লোড হচ্ছে...",
    adminOnly: "প্রশাসক অ্যাক্সেস প্রয়োজন",
    note: "নোট",
    insight: "অন্তর্দৃষ্টি",
    newSource: "নতুন উৎস",
    newNotebook: "নতুন ওয়ার্কস্পেস",
    language: "ভাষা",
    english: "English",
    chinese: "简体中文",
    japanese: "日本語",
  ...
  navigation: {
    askNavigator: "Navigator-কে জিজ্ঞাসা করুন",
    knowledge: "জ্ঞান",
    workspaces: "ওয়ার্কস্পেস",
    usersAccess: "ব্যবহারকারী ও অ্যাক্সেস",
    departments: "বিভাগ",
    analytics: "বিশ্লেষণ",
  ...
  notebooks: {
    createNewNamed: "\"{name}\" ওয়ার্কস্পেস তৈরি করুন",
    title: "ওয়ার্কস্পেস",
    newNotebook: "নতুন ওয়ার্কস্পেস",
    searchPlaceholder: "ওয়ার্কস্পেস খুঁজুন...",
    archived: "আর্কাইভ করা",
    archive: "আর্কাইভ",
    unarchive: "আর্কাইভ বাতিল",
    deleteNotebook: "ওয়ার্কস্পেস মুছুন",
    ...
    deleteNotebookExclusiveSources: "{count}টি সোর্স শুধুমাত্র এই ওয়ার্কস্পেসে রয়েছে।",
    deleteNotebookSharedSources: "{count}টি সোর্স অন্যান্য ওয়ার্কস্পেসের সাথে ভাগ করা আছে এবং আনলিঙ্ক করা হবে।",
    deleteNotebookNoSources: "এই ওয়ার্কস্পেসে কোনো সোর্স নেই।",
    deleteExclusiveSourcesLabel: "এক্সক্লুসিভ উৎসগুলি মুছে ফেলুন",
    keepExclusiveSourcesLabel: "আনলিংক করে রাখুন",
    activeNotebooks: "সক্রিয় ওয়ার্কস্পেস",
    archivedNotebooks: "আর্কাইভ করা ওয়ার্কস্পেস",
    tileView: "টাইল ভিউ",
    listView: "তালিকা ভিউ",
    notFound: "ওয়ার্কস্পেস পাওয়া যায়নি",
    notFoundDesc: "অনুরোধ করা ওয়ার্কস্পেসটি বিদ্যমান নেই।",
    updated: "আপডেট করা",
    namePlaceholder: "ওয়ার্কস্পেসের নাম",
    ...
    createNew: "নতুন ওয়ার্কস্পেস তৈরি করুন",
    createNewDesc: "শুরু করতে একটি নাম ও একটি ঐচ্ছিক বিবরণ লিখুন।",
    descPlaceholder: "এই ওয়ার্কস্পেস সম্পর্কে আরও তথ্য এখানে যোগ করুন...",
    createSuccess: "ওয়ার্কস্পেস সফলভাবে তৈরি হয়েছে",
    updateSuccess: "ওয়ার্কস্পেস সফলভাবে আপডেট হয়েছে",
    deleteSuccess: "ওয়ার্কস্পেস সফলভাবে মুছে ফেলা হয়েছে",
    recentlyViewed: "সম্প্রতি দেখা",
    toggleRecentlyViewed: "সম্প্রতি দেখা টগল করুন",
    recentlyViewedNotebook: "ওয়ার্কস্পেস",
  ...
  sources: {
    ...
    allSourcesDesc: "আপনার সংস্থা যা কিছু ইনডেক্স করেছে। নতুন ডকুমেন্ট যোগ করুন বা বিদ্যমানগুলি পরিচালনা করুন।",
    exportSummary: "এক্সেল সারাংশ রপ্তানি করুন",
    exportSummarySuccess: "সারাংশ রিপোর্ট ডাউনলোড হয়েছে",
    exportSummaryError: "সারাংশ রিপোর্ট রপ্তানি ব্যর্থ হয়েছে",
    allSources: "নলেজ",
    insights: "অন্তর্দৃষ্টি",
    yes: "হ্যাঁ",
    no: "না",
    ...
    allSourcesDescShort: "আপনার সংস্থা যা কিছু ইনডেক্স করেছে।",
    ...
    id: "উৎস ID",
    topics: "বিষয়বস্তু",
    embedded: "অনুসন্ধানের জন্য প্রস্তুত",
    ...
    previewFailed: "ফাইলের প্রিভিউ লোড করা যায়নি।",
  ...
  chat: {
    ...
    chatWithNotebook: "ওয়ার্কস্পেসের সাথে চ্যাট",
  ...
  searchPage: {
    ...
    conversationDisclaimer: "IRClass Navigator ভুল করতে পারে। গুরুত্বপূর্ণ তথ্য যাচাই করুন।",
    sourcesEmpty: "প্রশ্ন করলে উৎস এখানে প্রদর্শিত হবে",
    unifiedTitle: "IRClass Navigator-কে জিজ্ঞাসা করুন",
    unifiedSubtitle: "আপনার সংস্থার জ্ঞান থেকে প্রাপ্ত উত্তর",
    unifiedPlaceholder: "আপনার নথি, বিধি বা প্রতিবেদন সম্পর্কে যেকোনো কিছু জিজ্ঞাসা করুন…",
    aiNotConfigured: "AI উত্তর এখনও উপলব্ধ নয় — একজন অ্যাডমিনিস্ট্রেটরকে একটি মডেল কনফিগার করতে হবে। মিলে যাওয়া নথি নিচে দেখানো হচ্ছে।",
    includeNotes: "নোট অন্তর্ভুক্ত করুন",
    saveToWorkspace: "ওয়ার্কস্পেসে সংরক্ষণ করুন",
    matchingKnowledge: "মিলে যাওয়া জ্ঞান",
    emptyKbTitle: "আপনার নলেজ বেস খালি",
    emptyKbDesc: "প্রশ্ন জিজ্ঞাসা এবং নথি অনুসন্ধান শুরু করতে একটি উৎস যোগ করুন।",
    emptyKbAction: "আপনার প্রথম উৎস যোগ করুন",
    tryAsking: "এরকম কিছু জিজ্ঞাসা করে দেখুন",
    examplePrompts: {
      certRequirements: "মূল সার্টিফিকেশন প্রয়োজনীয়তাগুলি কী কী?",
      complianceUpdates: "সর্বশেষ কমপ্লায়েন্স আপডেটগুলির সারাংশ দিন",
      relatedDocuments: "সাম্প্রতিক অডিট সম্পর্কিত নথি খুঁজুন",
      processExplainer: "নিবন্ধন প্রক্রিয়া ব্যাখ্যা করুন",
    },
    search: "অনুসন্ধান",
  ...
  models: {
    ...
    visionModelDesc: "ছবি ও ফটো থেকে টেক্সট নিষ্কাশনের (OCR) জন্য ব্যবহৃত - সেট না থাকলে চ্যাট মডেল ব্যবহৃত হয়",
  ...
  gmail: {
    ...
    connectedServicesDesc: "বাহ্যিক অ্যাকাউন্ট যুক্ত করুন যাতে Navigator আপনার ডকুমেন্টের সাথে সেগুলিও বিশ্লেষণ করতে পারে। অ্যাক্সেস শুধুমাত্র পড়ার জন্য।",
    connected: "সংযুক্ত",
    connect: "Gmail সংযুক্ত করুন",
    disconnect: "সংযোগ বিচ্ছিন্ন করুন",
    disconnected: "Gmail সংযোগ বিচ্ছিন্ন হয়েছে",
    connectFailed: "Gmail সংযোগ শুরু করা যায়নি",
    disconnectFailed: "Gmail সংযোগ বিচ্ছিন্ন করা যায়নি",
    notConnectedDesc: "Navigator-কে আপনার ডকুমেন্টের পাশাপাশি আপনার মেইলবক্সে অনুসন্ধান করতে দিন। শুধুমাত্র পড়া — কিছুই পাঠানো বা পরিবর্তন করা হয় না।",
    notConfigured: "এই সার্ভারে Gmail ইন্টিগ্রেশন কনফিগার করা নেই।",
    lastChecked: "সর্বশেষ পরীক্ষা {{time}}",
    liveAccess: "লাইভ অ্যাক্সেস সক্রিয়",
    modeAuto: "স্বয়ংক্রিয়",
    modeAutoDesc: "শুধুমাত্র প্রশ্নে ইমেইলের উল্লেখ থাকলে Gmail-এ অনুসন্ধান করে",
    modeDocuments: "শুধুমাত্র ডকুমেন্ট",
    modeDocumentsDesc: "কখনও Gmail-এ অনুসন্ধান করে না",
    modeDocumentsGmail: "ডকুমেন্ট + Gmail",
    modeDocumentsGmailDesc: "সবসময় Gmail-এও অনুসন্ধান করে",
    matchingEmails: "ইমেইল",
    openInGmail: "Gmail-এ খুলুন",
    connectedToast: "Gmail সংযুক্ত হয়েছে",
    connectErrorToast: "Gmail সংযোগ ব্যর্থ হয়েছে — আবার চেষ্টা করুন",
