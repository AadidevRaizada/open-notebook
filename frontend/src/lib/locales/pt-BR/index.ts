export const ptBR = {
  settingsPage: {
    ...
    aiConfigDesc: "Modelos, ações de documentos e manutenção",
    aiModelsTitle: "Modelos de IA",
    aiModelsDesc: "Provedores, chaves de API e modelos padrão",
    documentActionsTitle: "Ações de documentos",
    documentActionsDesc: "Como resumos e insights são gerados",
    maintenanceTitle: "Manutenção",
    maintenanceDesc: "Reconstruir índices e ferramentas avançadas",
  },
  homePage: {
    securePrivate: "Seus dados estão seguros e privados",
    greetingMorning: "Bom dia",
    greetingAfternoon: "Boa tarde",
    greetingEvening: "Boa noite",
    welcomeSubtitle: "O que você gostaria de saber hoje?",
    askLabel: "Perguntar ao IRClass Navigator",
    askPlaceholder: "Pergunte qualquer coisa sobre seus documentos, regulamentos ou relatórios…",
    askButton: "Perguntar",
    example1: "Encontrar referências da MARPOL",
    example2: "Comparar relatórios de vistoria",
    example3: "Resumir as circulares mais recentes",
    example4: "Listar diretrizes sobre água de lastro",
    actionUploadTitle: "Enviar documentos",
    actionUploadDesc: "Adicione arquivos, links ou notas ao seu conhecimento",
    actionWorkspaceTitle: "Criar um espaço de trabalho",
    actionWorkspaceDesc: "Organize documentos e notas em torno de uma tarefa",
    actionKnowledgeTitle: "Biblioteca de conhecimento",
    actionKnowledgeDesc: "Navegue por tudo que sua organização indexou",
    actionInviteTitle: "Convidar usuários",
    actionInviteDesc: "Traga colegas para o IRClass Navigator",
    getStarted: "Começar",
    statDocuments: "Documentos indexados",
    statUsers: "Usuários",
    statQueries: "Consultas de conhecimento",
    recentWorkspaces: "Espaços de trabalho recentes",
    recentQuestions: "Perguntas recentes",
    recentKnowledge: "Conhecimento visualizado recentemente",
    viewAll: "Ver tudo",
    docsCount: "{count} documentos",
    noWorkspacesYet: "Nenhum espaço de trabalho ainda",
    noQuestionsYet: "As perguntas que você fizer aparecerão aqui",
    noKnowledgeYet: "Os documentos que você abrir aparecerão aqui",
    wizardTitle: "Bem-vindo ao IRClass Navigator",
    wizardSubtitle: "Três passos até sua primeira resposta",
    wizardStep1Title: "Envie seu primeiro documento",
    wizardStep1Desc: "PDFs, arquivos do Word, links e mais",
    wizardStep2Title: "Crie um espaço de trabalho",
    wizardStep2Desc: "Um lugar para organizar trabalhos relacionados",
    wizardStep3Title: "Faça sua primeira pergunta",
    wizardStep3Desc: "As respostas vêm dos seus próprios documentos",
  },
  adminPage: {
    departmentsTab: "Departamentos",
    title: "Administração",
    ...
    actionSuccess: "Concluído",
    actionError: "A ação falhou",
    inviteTitle: "Convidar um usuário",
    invitePlaceholder: "email@example.com",
    inviteButton: "Enviar convite",
    inviteModeNewOrg: "Nova organização",
    inviteModeExistingOrg: "Organização existente",
    inviteModeNewOrgDesc: "Cria uma nova organização — o usuário convidado se torna o administrador dela.",
    inviteModeExistingOrgDesc: "O usuário convidado entra na organização selecionada como membro.",
    ...
    usageTitle: "Uso por usuário",
    usageEmpty: "Nenhuma atividade registrada ainda.",
    usageTotal: "Total",
    lastActive: "Última atividade",
    recentActivity: "Atividade recente",
    organizationsTitle: "Departamentos",
    organizationsDesc: "Entre em qualquer departamento para ver e gerenciar seu conteúdo isolado. Troque o departamento ativo na barra superior.",
    ...
    actions: {
      ...
      transformationRun: "Transformações",
      exportReport: "Relatórios",
    },
  },
  common: {
    appSubtitle: "Plataforma de inteligência de conhecimento marítimo",
    fiftyYearsAlt: "50 anos de IRClass",
    search: "Buscar...",
    create: "Novo",
    new: "Novo",
    cancel: "Cancelar",
    ...
    newNotebook: "Novo espaço de trabalho",
    language: "Idioma",
    english: "English",
    chinese: "简体中文",
    japanese: "日本語",
  ...
  navigation: {
    askNavigator: "Perguntar ao Navigator",
  ...
  notebooks: {
    createNewNamed: "Criar espaço de trabalho \"{name}\"",
    ...
    deleteNotebook: "Excluir espaço de trabalho",
    ...
    deleteNotebookExclusiveSources: "{count} fonte(s) existem apenas neste espaço de trabalho.",
    deleteNotebookSharedSources: "{count} fonte(s) são compartilhadas com outros espaços de trabalho e serão desvinculadas.",
    deleteNotebookNoSources: "Nenhuma fonte neste espaço de trabalho.",
    deleteExclusiveSourcesLabel: "Excluir fontes exclusivas",
    keepExclusiveSourcesLabel: "Desvincular e manter",
    activeNotebooks: "Espaços de trabalho ativos",
    archivedNotebooks: "Espaços de trabalho arquivados",
    tileView: "Visualização em blocos",
    listView: "Visualização em lista",
    notFound: "Espaço de trabalho não encontrado",
    notFoundDesc: "O espaço de trabalho solicitado não existe.",
    updated: "Atualizado",
    ...
    createNew: "Criar novo espaço de trabalho",
    createNewDesc: "Digite um nome e uma descrição opcional para começar.",
    descPlaceholder: "Adicione mais informações sobre este espaço de trabalho aqui...",
    createSuccess: "Espaço de trabalho criado com sucesso",
    updateSuccess: "Espaço de trabalho atualizado com sucesso",
    ...
    recentlyViewedNotebook: "Espaço de trabalho",
  ...
  sources: {
    ...
    allSourcesDesc: "Tudo o que sua organização indexou. Adicione novos documentos ou gerencie os existentes.",
    exportSummary: "Exportar resumo em Excel",
    exportSummarySuccess: "Relatório de resumo baixado",
    exportSummaryError: "Falha ao exportar o relatório de resumo",
    allSources: "Conhecimento",
    insights: "Insights",
    yes: "Sim",
    no: "Não",
    loadingMore: "Carregando mais...",
    noSourcesYet: "Nenhuma fonte ainda",
    allSourcesDescShort: "Tudo o que sua organização indexou.",
    ...
    previewFailed: "Não foi possível carregar a pré-visualização do arquivo.",
  ...
  chat: {
    ...
    chatWithNotebook: "Chat com o espaço de trabalho",
  ...
  searchPage: {
    ...
    conversationDisclaimer: "O IRClass Navigator pode cometer erros. Verifique informações importantes.",
    sourcesEmpty: "As fontes aparecerão aqui depois que você fizer uma pergunta",
    unifiedTitle: "Perguntar ao IRClass Navigator",
    unifiedSubtitle: "Respostas extraídas do conhecimento da sua organização",
    unifiedPlaceholder: "Pergunte qualquer coisa sobre seus documentos, regulamentos ou relatórios…",
    aiNotConfigured: "As respostas de IA ainda não estão disponíveis — um administrador precisa configurar um modelo. Os documentos correspondentes continuam exibidos abaixo.",
    includeNotes: "Incluir notas",
    saveToWorkspace: "Salvar no espaço de trabalho",
    matchingKnowledge: "Conhecimento correspondente",
    emptyKbTitle: "Sua base de conhecimento está vazia",
    emptyKbDesc: "Adicione uma fonte para começar a fazer perguntas e pesquisar seus documentos.",
    emptyKbAction: "Adicione sua primeira fonte",
    tryAsking: "Experimente perguntar algo como",
    examplePrompts: {
      certRequirements: "Quais são os principais requisitos de certificação?",
      complianceUpdates: "Resuma as últimas atualizações de conformidade",
      relatedDocuments: "Encontre documentos relacionados a auditorias recentes",
      processExplainer: "Explique o processo de registro",
    },
    search: "Buscar",
  ...
  models: {
    ...
    visionModelDesc: "Usado para extrair texto de imagens e fotos (OCR) – usa o modelo de chat se não definido",
  ...
  gmail: {
    ...
    connectedServicesDesc: "Vincule contas externas para que o Navigator possa raciocinar sobre elas junto com seus documentos. O acesso é somente leitura.",
    connected: "Conectado",
    connect: "Conectar Gmail",
    disconnect: "Desconectar",
    disconnected: "Gmail desconectado",
    connectFailed: "Não foi possível iniciar a conexão com o Gmail",
    disconnectFailed: "Não foi possível desconectar o Gmail",
    notConnectedDesc: "Permita que o Navigator pesquise sua caixa de entrada junto com seus documentos. Somente leitura — nada é enviado ou alterado.",
    notConfigured: "A integração com o Gmail não está configurada neste servidor.",
    lastChecked: "Última verificação {{time}}",
    liveAccess: "Acesso ao vivo ativado",
    modeAuto: "Auto",
    modeAutoDesc: "Pesquisa o Gmail apenas quando sua pergunta menciona e-mails",
    modeDocuments: "Somente documentos",
    modeDocumentsDesc: "Nunca pesquisa o Gmail",
    modeDocumentsGmail: "Documentos + Gmail",
    modeDocumentsGmailDesc: "Sempre pesquisa o Gmail também",
    matchingEmails: "E-mails",
    openInGmail: "Abrir no Gmail",
    connectedToast: "Gmail conectado",
    connectErrorToast: "Falha na conexão com o Gmail — tente novamente",
