export const jaJP = {
  settingsPage: {
    aiConfigTitle: "AI 設定",
    aiConfigDesc: "モデル、文書アクション、メンテナンス",
    aiModelsTitle: "AI モデル",
    aiModelsDesc: "プロバイダー、API キー、既定のモデル",
    documentActionsTitle: "文書アクション",
    documentActionsDesc: "要約とインサイトの生成方法",
    maintenanceTitle: "メンテナンス",
    maintenanceDesc: "インデックスの再構築と高度なツール",
  },
  homePage: {
    securePrivate: "あなたのデータは安全かつプライベートです",
    greetingMorning: "おはようございます",
    greetingAfternoon: "こんにちは",
    greetingEvening: "こんばんは",
    welcomeSubtitle: "今日は何をお知りになりたいですか?",
    askLabel: "IRClass Navigator に質問する",
    askPlaceholder: "文書、規則、報告書について何でも質問してください…",
    askButton: "質問する",
    example1: "MARPOL の参照箇所を探す",
    example2: "検査報告書を比較する",
    example3: "最新の回章を要約する",
    example4: "バラスト水ガイダンスを一覧表示する",
    actionUploadTitle: "文書をアップロード",
    actionUploadDesc: "ファイル、リンク、メモをナレッジに追加します",
    actionWorkspaceTitle: "ワークスペースを作成",
    actionWorkspaceDesc: "タスクを中心に文書とメモを整理します",
    actionKnowledgeTitle: "ナレッジライブラリ",
    actionKnowledgeDesc: "組織がインデックスしたすべてを閲覧します",
    actionInviteTitle: "ユーザーを招待",
    actionInviteDesc: "同僚を IRClass Navigator に招待します",
    getStarted: "始める",
    statDocuments: "インデックス済み文書",
    statUsers: "ユーザー",
    statQueries: "ナレッジクエリ",
    recentWorkspaces: "最近のワークスペース",
    recentQuestions: "最近の質問",
    recentKnowledge: "最近閲覧したナレッジ",
    viewAll: "すべて表示",
    docsCount: "{count} 件の文書",
    noWorkspacesYet: "ワークスペースはまだありません",
    noQuestionsYet: "質問するとここに表示されます",
    noKnowledgeYet: "開いた文書がここに表示されます",
    wizardTitle: "IRClass Navigator へようこそ",
    wizardSubtitle: "最初の回答まで 3 ステップ",
    wizardStep1Title: "最初の文書をアップロード",
    wizardStep1Desc: "PDF、Word ファイル、リンクなど",
    wizardStep2Title: "ワークスペースを作成",
    wizardStep2Desc: "関連する作業を整理する場所",
    wizardStep3Title: "最初の質問をする",
    wizardStep3Desc: "回答はご自身の文書から生成されます",
  },
  adminPage: {
    departmentsTab: "部門",
    title: "管理",
    ...
    inviteSuccess: "{email} に招待を送信しました",
    inviteError: "招待の送信に失敗しました",
    actionSuccess: "完了しました",
    actionError: "操作に失敗しました",
    inviteTitle: "ユーザーを招待",
    invitePlaceholder: "email@example.com",
    inviteButton: "招待を送信",
    inviteModeNewOrg: "新しい組織",
    inviteModeExistingOrg: "既存の組織",
    inviteModeNewOrgDesc: "新しい組織を作成し、招待されたユーザーがその管理者になります。",
    inviteModeExistingOrgDesc: "招待されたユーザーは選択した組織にメンバーとして参加します。",
    ...
    usageTitle: "ユーザー別の利用状況",
    usageEmpty: "まだアクティビティは記録されていません。",
    usageTotal: "合計",
    lastActive: "最終アクティブ",
    recentActivity: "最近のアクティビティ",
    organizationsTitle: "部門",
    organizationsDesc: "部門に参加すると、その独立したコンテンツを表示・管理できます。アクティブな部門は上部バーから切り替えられます。",
    ...
    actions: {
      ...
      search: "検索",
      ask: "質問",
      podcastGenerated: "ポッドキャスト",
      transformationRun: "変換",
      exportReport: "レポート",
    },
  },
  common: {
    appSubtitle: "海事ナレッジインテリジェンスプラットフォーム",
    fiftyYearsAlt: "IRClass 50 周年",
    search: "検索...",
    create: "新規",
    new: "新規",
    cancel: "キャンセル",
  ...
  notebooks: {
    createNewNamed: "ワークスペース「{name}」を作成",
    title: "ワークスペース",
    newNotebook: "新しいワークスペース",
    ...
    deleteNotebookExclusiveSources: "{count}件のソースはこのワークスペースにのみ存在します。",
    deleteNotebookSharedSources: "{count}件のソースは他のワークスペースと共有されており、リンクが解除されます。",
    deleteNotebookNoSources: "このワークスペースにソースはありません。",
    deleteExclusiveSourcesLabel: "専用ソースを削除",
    keepExclusiveSourcesLabel: "リンク解除して保持",
    activeNotebooks: "アクティブなワークスペース",
    archivedNotebooks: "アーカイブ済みワークスペース",
    tileView: "タイル表示",
    listView: "リスト表示",
    notFound: "ワークスペースが見つかりません",
    notFoundDesc: "指定されたワークスペースは存在しません。",
    updated: "更新日時",
  ...
  sources: {
    ...
    allSourcesDesc: "組織がインデックスしたすべての情報。新しいドキュメントを追加したり、既存のものを管理したりできます。",
    exportSummary: "Excelサマリーをエクスポート",
    exportSummarySuccess: "サマリーレポートをダウンロードしました",
    exportSummaryError: "サマリーレポートのエクスポートに失敗しました",
    allSources: "ナレッジ",
    insights: "インサイト",
    yes: "はい",
    no: "いいえ",
    ...
    allSourcesDescShort: "組織がインデックスしたすべての情報。",
    ...
    previewFailed: "ファイルのプレビューを読み込めませんでした。",
  ...
  searchPage: {
    sources: "ソース",
    regenerate: "再生成",
    conversationDisclaimer: "IRClass Navigator は誤ることがあります。重要な情報は確認してください。",
    sourcesEmpty: "質問するとソースがここに表示されます",
    unifiedTitle: "IRClass Navigator に質問する",
    unifiedSubtitle: "組織のナレッジに基づく回答",
    unifiedPlaceholder: "文書、規則、報告書について何でも質問してください…",
    aiNotConfigured: "AI 回答はまだ利用できません。管理者によるモデルの設定が必要です。一致する文書は下に表示されます。",
    includeNotes: "メモを含める",
    saveToWorkspace: "ワークスペースに保存",
    matchingKnowledge: "一致するナレッジ",
    emptyKbTitle: "ナレッジベースは空です",
    emptyKbDesc: "ソースを追加して、質問やドキュメント検索を始めましょう。",
    emptyKbAction: "最初のソースを追加",
    tryAsking: "こんな質問を試してみてください",
    examplePrompts: {
      certRequirements: "主要な認証要件は何ですか？",
      complianceUpdates: "最新のコンプライアンス更新を要約して",
      relatedDocuments: "最近の監査に関連するドキュメントを探して",
      processExplainer: "登録プロセスを説明して",
    },
    search: "検索",
  ...
  models: {
    ...
    visionModelDesc: "画像や写真からのテキスト抽出（OCR）に使用 - 未設定の場合はチャットモデルを使用",
  ...
  gmail: {
    ...
    connectedServicesDesc: "外部アカウントを連携すると、Navigator がドキュメントと合わせて分析できます。アクセスは読み取り専用です。",
    connected: "連携済み",
    connect: "Gmail を連携",
    disconnect: "連携解除",
    disconnected: "Gmail の連携を解除しました",
    connectFailed: "Gmail の連携を開始できませんでした",
    disconnectFailed: "Gmail の連携解除に失敗しました",
    notConnectedDesc: "Navigator がドキュメントと合わせてメールボックスを検索できるようにします。読み取り専用のため、送信や変更は行われません。",
    notConfigured: "このサーバーでは Gmail 連携が設定されていません。",
    lastChecked: "最終確認 {{time}}",
    liveAccess: "ライブアクセス有効",
    modeAuto: "自動",
    modeAutoDesc: "質問がメールに関するときのみ Gmail を検索します",
    modeDocuments: "ドキュメントのみ",
    modeDocumentsDesc: "Gmail は検索しません",
    modeDocumentsGmail: "ドキュメント + Gmail",
    modeDocumentsGmailDesc: "常に Gmail も検索します",
    matchingEmails: "メール",
    openInGmail: "Gmail で開く",
    connectedToast: "Gmail を連携しました",
    connectErrorToast: "Gmail の連携に失敗しました。もう一度お試しください",
